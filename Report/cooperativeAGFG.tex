...
\end{equation}
\\ \\
We compute the \textbf{task reference} applying the Cartesian error between the vehicle frame and the goal frame, both projected on the world frame.\\
The misalignment between the two is computed by the Unit Vector Lemma.\\
...
\begin{tabular}{ | c | c | c |}
\hline
 Control Task & Action A & Action B \\
 \hline
 MAV & Active & Inactive\\  
 Manipulabity & Active & Active\\
 Horizonatal Attitude & Active & Active\\
 Vehicle Position & Active & Inactive \\
 Landing & Inactive & Active\\
...
\hline
 Control Task & Action A & Action B & Action C \\
 \hline
 MAV & Active & Active & Inactive \\  
 Manipulabity & Active & Active & Active  \\
 Horizonatal Attitude & Active & Active & Active\\
 Vehicle Position & Active & Inactive & Inactive \\
 Alignment to the rock & Inactive & Active & Active \\
 Landing & Inactive & Inactive & Active\\
 \hline
\end{tabular}
\end{center}
...
\hline
 Control Task & Action A & Action B & Action C & Action D\\
 \hline
 Vehicle Null Velocity & Inactive & Inactive & Inactive & Active\\
 MAV & Active & Active & Inactive & Inactive \\  
 Manipulabity & Active & Active & Active & Active  \\
 Horizontal Attitude & Active & Active & Active & Active\\
 Vehicle Position & Active & Inactive & Inactive & Inactive\\
 Alignment to the rock & Inactive & Active & Active & Inactive \\
 Landing & Inactive & Inactive & Active & Inactive\\
 \hline
\end{tabular}
\end{center}
\begin{figure}[h]
...
\begin{figure}[!h]
    ...
    \includegraphics[scale=0.4]{comment.png}
    \caption{Preferred Shape Task Active}
    \end{minipage}
\hfill
    \centering
    \begin{minipage}{0.40\textwidth}
    \includegraphics[scale=0.4]{uncomment.png}
    \caption{Preferred Shape Task Inactive}
    \end{minipage}
\end{figure}
