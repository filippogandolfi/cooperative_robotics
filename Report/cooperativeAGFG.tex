...
\begin{description}
 ...
 \item Action C performs the safe landing on the seafloor. \textit{Alignment to the Rock} is gradually disabled to optimize the alignment while the robot is performing the landing (Figure \ref{311c}). \end{description}
